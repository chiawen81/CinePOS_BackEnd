...
router.post('/', auth_1.default.isEmpAuth, response_1.default.setHeaderCROS, upload_1.default.uploadValidator, error_1.default.handleErrorAsync(upload_1.default.upload), error_1.default.handleErrorAsync(upload_1.default.getUploadSuccessInfo));
