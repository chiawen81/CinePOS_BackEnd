...
router.get('/profile/:staffId', auth_1.default.isEmpAuth, auth_1.default.isOwnerAuth, response_1.default.setHeaderCROS, error_1.default.handleErrorAsync(user_1.default.getUserProfile));
router.post('/profile', auth_1.default.isEmpAuth, auth_1.default.isOwnerAuth, response_1.default.setHeaderCROS, error_1.default.handleErrorAsync(user_1.default.changeUserName));
